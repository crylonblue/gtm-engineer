...
const parameters = z.object({
  query: z.string().optional().describe("Full-text search query across deals"),
  filterGroups: z
...
export const searchDealsTool: ToolDefinition<Params> = {
  name: "hubspot_search_deals",
  description:
    "Search HubSpot deals by full-text query or property filters. Returns matching deals with specified properties.",
  provider: "hubspot",
  category: "crm",
  parameters,
  execute,
