...
const parameters = z.object({
  query: z.string().optional().describe("Full-text search query across companies"),
  filterGroups: z
...
export const searchCompaniesTool: ToolDefinition<Params> = {
  ...
  description:
    "Search HubSpot companies by full-text query or property filters. Returns matching companies with specified properties.",
  provider: "hubspot",
  category: "crm",
  parameters,
  execute,
